...
TOKEN = '7359064005:AAH-_BlRfxN7J1TavviJe6YJE_gHriWlcFM'
...
FORWARD_CHANNEL_ID = -4239527606
CHANNEL_ID = -4239527606
error_channel_id = -4239527606
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.reply_to(message, "*Contact admin @Adityaddos*", parse_mode='Markdown')
    else:
